...
\begin{tabular}{@{}p{2cm}p{6.5cm}}
   ...
   \href{http://www.ada-auth.org/standards/22rm/html/RM-6-1-1.html}{\textit{Post}} & \texttt{with Post => Condition}

   Postcondition; a condition that will hold true after a call.\\

   \href{http://www.ada-auth.org/standards/22rm/html/RM-6-1-1.html}{\textit{Post'Class}} & \texttt{with Post'Class}

   Postcondition that applies to corresponding subprograms of descendant types.\\

   \href{http://www.ada-auth.org/standards/22rm/html/RM-6-1-1.html}{\textit{Pre}} & \texttt{with Pre => Condition}

   Precondition; a condition that is expected to hold true before a call.\\

   \href{http://www.ada-auth.org/standards/22rm/html/RM-6-1-1.html}{\textit{Pre'Class}} & \texttt{with Pre'Class => Condition}
...
\begin{tabular}{@{}p{2cm}p{6.5cm}}
   ...
   \href{http://www.ada-auth.org/standards/22rm/html/RM-9-10-1.html}{Conflict\_Check\_Policy} & \textit{pragma Conflict\_Check\_Policy (policy\_identifier[, policy\_identifier])}
